...
const en: Translations = {
  ...
  "nav.signup": "Sign up",
  "hero.headline": "Build a More Disciplined Trading Process",
  "hero.subheadline": "Choose an evaluation, follow its rules, and track eligible account progress.",
  ...
  "footer.companyName": "FYNX Funded",
  "theme.dark": "Dark",
  "theme.light": "Light",
