...
const errorMap: Record<string, string> = {
  ...
  "auth/cancelled-popup-request": "Another sign-in window is already open. Finish it or try again.",
  "auth/account-exists-with-different-credential": "An account already exists with this email. Log in using the original sign-in method, then connect this provider in Settings.",
  "auth/credential-already-in-use": "This sign-in account is already connected to another FYNX account.",
