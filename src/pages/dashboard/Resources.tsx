...
const links=[
  ...
  ["FYNX Blog","Read product updates, market perspectives and FYNX articles.","https://elhamamini.cc/fynx-blog/index.html",Newspaper],
  ["Product Roadmap","Follow the public roadmap for the growing FYNX ecosystem.","https://elhamamini.cc/RoadMap-FYNX/",Globe2],
  ["FYNX Funded","Return to the FYNX Funded challenge platform.","https://www.fynxfunded.com",Globe2],
