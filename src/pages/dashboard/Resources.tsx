...
const links=[
  ...
  ["FYNX Blog","Read product updates, market perspectives and FYNX articles.","https://blog.fynxfinanceworld.com",Newspaper],
  ["Product Roadmap","Follow the public roadmap for the growing FYNX ecosystem.","https://roadmap.fynxfinanceworld.com",Globe2],
